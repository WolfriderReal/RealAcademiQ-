      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="flex items-center justify-between mb-6">
            {[1, 2, 3].map((s) => (
              <div key={s} className="flex items-center">
                ...
                {s < 3 && (
                  <div className={`h-1 flex-1 mx-2 transition-all ${step > s ? 'bg-orange-500' : 'bg-white/10'}`} />
                )}
              </div>
            ))}
          </div>
        ...
        {step === 3 && !submitted && orderId && (
          <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-lg">
            ...
            {/* PayPal Panel */}
            {selectedPayment === 'paypal' && (
              <div className="border border-blue-400/30 rounded-xl p-6 mb-6 bg-blue-500/10">
            ...
            {/* M-Pesa STK Panel */}
            {selectedPayment === 'mpesa' && (
              <div className="border border-orange-400/30 rounded-xl p-6 mb-6 bg-orange-500/10">
        ...
        {submitted && orderId && (
          <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-lg text-center">
            ...
            {/* Next Steps */}
            <div className="bg-blue-500/10 rounded-lg p-6 mb-6 text-left border border-blue-400/30">
